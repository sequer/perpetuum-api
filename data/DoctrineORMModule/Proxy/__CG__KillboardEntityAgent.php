...
namespace DoctrineORMModule\Proxy\__CG__\Killboard\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Agent extends \Killboard\Entity\Agent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'uid', '' . "\0" . 'Killboard\\Entity\\Agent' . "\0" . 'name', '' . "\0" . 'Killboard\\Entity\\Agent' . "\0" . 'corporation', '' . "\0" . 'Killboard\\Entity\\Agent' . "\0" . 'deaths', '' . "\0" . 'Killboard\\Entity\\Agent' . "\0" . 'kills', 'id'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCorporation(\Killboard\Entity\Corporation $corporation)
    {
