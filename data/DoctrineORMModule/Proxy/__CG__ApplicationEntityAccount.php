 ...
 */
class Account extends \Application\Entity\Account implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'email', 'password', 'createdOn', 'hasEmailConfirmed', 'id'];
        }
    ...
    public function hasEmailConfirmed(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasEmailConfirmed', []);

        return parent::hasEmailConfirmed();
    }

    /**
     * {@inheritDoc}
     */
    public function prePersist(\Doctrine\Common\Persistence\Event\LifecycleEventArgs $args)
    {
